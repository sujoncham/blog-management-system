...
const blogs = [
    {
        ...
        img:"/images/casework1.jpg",
        author:"/images/client2.png"
    },
    {
        id: 2,
        title: "John Smith", 
        ...
        img:"/images/casework2.jpg",
        author:"/images/client1.png"
    },
    {
        id: 3,
        title: "Ben Stokes", 
        ...
        img:"/images/casework3.jpeg",
        author:"/images/client3.png"
    },
    {
        id: 4,
        title: "Ben Stokes", 
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 py-8'>
                {
                    blogs.map(blog =><div className={`relative ${Styles.contentHieght}`} key={blog.id}>
                        <img className='w-[100%] h-[250px]' src={blog.img} alt="" />
                        <div className={`bg-gray-200 pl-1 ${Styles.contentWidth} rounded-lg mt-[-30px] z-40 absolute`}>
                            <div className='flex justify-start items-end gap-1 mt-[-15px]'>
                                <img className='w-12 h-12 rounded-full border-4 border-gray-300 z-10' src={blog.author} alt="" />
